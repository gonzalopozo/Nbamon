...
const sectionSeleccionarJugador = document.getElementById(
    "seleccionar-jugador",
);
...
let lebronJames = new Nbamon(
    "Lebron-James",
    "./assets/nbamons_nbamon_lebronJames_attack.jpg",
    5,
    "lakers",
    "./assets/lebronJames.png",
);

let damianLillard = new Nbamon(
    "Damian-Lillard",
    "./assets/nbamons_nbamon_damianLillard_attack.jpg",
    5,
    "blazers",
    "./assets/damianLillard.png",
);

let giannisAntetokoumpo = new Nbamon(
    "Giannis-Antetokoumpo",
    "./assets/nbamons_nbamon_giannisAntetokoumpo_attack.jpg",
    5,
    "bucks",
    "./assets/giannisAntetokoumpo.png",
);

let anthonyDavis = new Nbamon(
    "Anthony-Davis",
    "./assets/nbamons_nbamon_anthonyDavis_attack.jpg",
    5,
    "lakers",
    "./assets/anthonyDavis.png",
);

let jimmyButler = new Nbamon(
    "Jimmy-Butler",
    "./assets/nbamons_nbamon_jimmyButler_attack.jpg",
    5,
    "heat",
    "./assets/jimmyButler.png",
);

let kawhiLeonard = new Nbamon(
    "Kawhi-Leonard",
    "./assets/nbamons_nbamon_kawhiLeonard_attack.jpg",
    5,
    "clippers",
    "./assets/kawhiLeonard.png",
);
...
function iniciarJuego() {
    ...
    nbamones.forEach((nbamon) => {
        ...
        inputGiannisAntetokoumpo = document.getElementById(
            "Giannis-Antetokoumpo",
        );
...
function obtenerTiros() {
    fetch(`/nbamon/${enemigoId}/ataques`).then(function (res) {
        if (res.ok) {
...
function combate() {
    ...
    for (let index = 0; index < tiroJugador.length; index++) {
        if (tiroJugador[index] === tiroEnemigo[index]) {
            ...
            (tiroJugador[index] == "MATE" && tiroEnemigo[index] == "PASE") ||
            (tiroJugador[index] == "TAPÓN" && tiroEnemigo[index] == "MATE") ||
            (tiroJugador[index] == "PASE" && tiroEnemigo[index] == "TAPÓN")
        ) {
            indexAmboxOponente(index, index);
...
function pintarCanvas() {
    personajeDelJugadorObjeto.x =
        personajeDelJugadorObjeto.x + personajeDelJugadorObjeto.velocidadX;
    personajeDelJugadorObjeto.y =
        personajeDelJugadorObjeto.y + personajeDelJugadorObjeto.velocidadY;
...
function revisarColision(enemigo) {
    ...
    const abajoNbamon =
        personajeDelJugadorObjeto.y + personajeDelJugadorObjeto.alto - 25;
    const derechaNbamon =
        personajeDelJugadorObjeto.x + personajeDelJugadorObjeto.ancho - 25;
